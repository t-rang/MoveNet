...
parent_path = "/Users/mac/Desktop/1-Thesis/[Code]/By Trang/220614_MoveNet/"
# ur_path = f"{parent_path}/data/ur"
# charfi_coffee_room_path = f"{parent_path}/data/charfi_coffee_room"
# charfi_home_path = f"{parent_path}/data/charfi_home"
# charfi_lecture_path = f"{parent_path}/data/charfi_lecture"
# charfi_office_path = f"{parent_path}/data/charfi_office"
charfi_office_2_path = f"{parent_path}/data/charfi_office_2"
...
# print(ur_fall)
# print(charfi_fall)
print(charfi_office_2_dataset.fall)
